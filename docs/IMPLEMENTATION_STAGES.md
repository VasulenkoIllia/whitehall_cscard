# Архів: початковий план реалізації на Node.js

Статус документа (2026-03-21):
- Це історичний план раннього етапу міграції.
- Документ не є джерелом поточного стану системи.
- Актуальні статуси та backlog:
  - `docs/CURRENT_FUNCTIONALITY.md`
  - `docs/PLAN_MODULAR_SINGLE_REPO_2026_03.md`
  - `docs/PLAN_FRONTEND_REACT_MIGRATION_2026_03.md`
